...
public class NotContainsRuleTransformerTests
{
    ...
    public void Transform_WithSingleValue_ShouldGenerateSingleNotLikeCondition()
    {
        ...
        // Assert
        Assert.Equal("Name NOT LIKE '%' + @param0 + '%'", query);
    ...
    public void Transform_WithMultipleValues_ShouldGenerateAndConditions()
    {
        ...
        // Assert
        Assert.Equal("(Name NOT LIKE '%' + @param0 + '%' AND Name NOT LIKE '%' + @param1 + '%')", query);
        Assert.NotNull(parameters);
    ...
    public void Transform_WithThreeValues_ShouldGenerateThreeAndConditions()
    {
        ...
        // Assert
        Assert.Equal("(Description NOT LIKE '%' + @param0 + '%' AND Description NOT LIKE '%' + @param1 + '%' AND Description NOT LIKE '%' + @param2 + '%')", query);
        Assert.NotNull(parameters);
    ...
    public void Transform_WithList_ShouldHandleListValues()
    {
        ...
        // Act
        var (query, parameters) = _transformer.Transform(rule, "Content", "@param");

        // Assert
        Assert.Equal("(Content NOT LIKE '%' + @param0 + '%' AND Content NOT LIKE '%' + @param1 + '%')", query);
        Assert.NotNull(parameters);
        Assert.Equal(2, parameters.Length);
    ...
    public void Transform_WithComplexFieldName_ShouldUseFieldNameAsIs()
    {
        ...
        // Assert
        Assert.Equal("[User].[Profile].[Name] NOT LIKE '%' + @param0 + '%'", query);
        Assert.NotNull(parameters);
        Assert.Single(parameters);
        Assert.Equal("test", parameters[0]);
    }
    ...
    public void Transform_WithDifferentParameterName_ShouldUseProvidedParameterName()
    {
        ...
        // Assert
        Assert.Equal("(Name NOT LIKE '%' + @customParam0 + '%' AND Name NOT LIKE '%' + @customParam1 + '%')", query);
        Assert.NotNull(parameters);
        Assert.Equal(2, parameters.Length);
    }
    ...
    public void Transform_WithNumericValues_ShouldHandleNonStringTypes()
    {
        ...
        // Assert
        Assert.Equal("(Code NOT LIKE '%' + @param0 + '%' AND Code NOT LIKE '%' + @param1 + '%')", query);
        Assert.NotNull(parameters);
        Assert.Equal(2, parameters.Length);
    ...
    public void Transform_WithSpecialCharacters_ShouldPreserveSpecialCharacters()
    {
        ...
        // Assert
        Assert.Equal("Email NOT LIKE '%' + @param0 + '%'", query);
        Assert.NotNull(parameters);
        Assert.Single(parameters);
    ...
    public void Transform_WithMixedTypes_ShouldHandleMixedTypeArray()
    {
        ...
        // Assert
        Assert.Equal("(Data NOT LIKE '%' + @param0 + '%' AND Data NOT LIKE '%' + @param1 + '%' AND Data NOT LIKE '%' + @param2 + '%')", query);
        Assert.NotNull(parameters);
        Assert.Equal(3, parameters.Length);
    ...
    public void Transform_WithFourValues_ShouldGenerateFourAndConditions()
    {
        ...
        // Act
        var (query, parameters) = _transformer.Transform(rule, "Comment", "@param");

        // Assert
        Assert.Equal("(Comment NOT LIKE '%' + @param0 + '%' AND Comment NOT LIKE '%' + @param1 + '%' AND Comment NOT LIKE '%' + @param2 + '%' AND Comment NOT LIKE '%' + @param3 + '%')", query);
        Assert.NotNull(parameters);
