...
public class PostgreSqlEdgeCaseTests
{
    [Fact]
    public void PostgreSqlFilterBuilder_WithNullFieldName_ShouldThrowArgumentNullException()
    {
        // Arrange
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithEmptyFieldName_ShouldThrowArgumentNullException()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithWhitespaceFieldName_ShouldThrowArgumentNullException()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithSpecialCharactersInFieldName_ShouldEscapeProperly()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithVeryLongFieldName_ShouldHandle()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
        ...
        // Assert
        Assert.Equal($"\"{longFieldName}\" = $1", query);
        Assert.NotNull(parameters);
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithNullValues_ShouldHandleCorrectly()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
        ...
        // Assert
        Assert.Contains("\"Field1\" = $1", query);
        Assert.Contains("\"Field2\" != $1", query);
        Assert.NotNull(parameters);
        Assert.Empty(parameters);
    }

    [Fact]
    public void PostgreSqlFilterBuilder_WithEmptyArrayForInOperator_ShouldThrowArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithSingleItemArrayForInOperator_ShouldWork()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
        ...
        // Assert
        Assert.Equal("\"Status\" IN ($10)", query);
        Assert.NotNull(parameters);
        Assert.Single(parameters);
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithMixedTypesInArray_ShouldHandleCorrectly()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
        ...
        // Assert
        Assert.Equal("\"MixedField\" IN ($10, $11, $12, $13)", query);
        Assert.NotNull(parameters);
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithInvalidConditionType_ShouldDefaultToAnd()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithUnicodeFieldNames_ShouldWork()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
        ...
        // Assert
        Assert.Contains("\"用户名\" = $1", query);
        Assert.Contains("\"пользователь\" = $2", query);
        Assert.Contains("\"🚀Field\" = $3", query);
        Assert.NotNull(parameters);
        Assert.Equal(3, parameters.Length);
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithExtremelyDeepNesting_ShouldNotStackOverflow()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithCircularReference_ShouldNotCauseInfiniteLoop()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithZeroLengthBetweenArray_ShouldThrowArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithSingleValueBetweenArray_ShouldThrowArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
    ...
    [Fact]
    public void PostgreSqlFilterBuilder_WithMoreThanTwoValuesBetweenArray_ShouldThrowArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddPostgreSqlFilterBuilder();
