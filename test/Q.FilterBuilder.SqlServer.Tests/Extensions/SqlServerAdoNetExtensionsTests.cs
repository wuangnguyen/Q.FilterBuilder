...
public class SqlServerAdoNetExtensionsTests
{
    [Fact]
    public void AddParameters_AddsParametersWithCorrectNamesAndValues()
    {
        // Arrange
        ...
        Assert.Equal("@p0", command.TestParameters.Parameters[0].ParameterName);
        Assert.Equal("foo", command.TestParameters.Parameters[0].Value);
        Assert.Equal("@p1", command.TestParameters.Parameters[1].ParameterName);
        Assert.Equal(42, command.TestParameters.Parameters[1].Value);
        Assert.Equal("@p2", command.TestParameters.Parameters[2].ParameterName);
